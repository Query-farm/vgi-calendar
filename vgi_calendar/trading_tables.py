...
class TradingSessionsFunction(TableFunctionGenerator[_TradingSessionsArgs]):
    ...
    class Meta:
        ...
        examples = [
            FunctionExample(
                sql="SELECT * FROM cal.main.trading_sessions(DATE '2026-01-01', DATE '2026-01-31')",
                description="NYSE sessions in January 2026",
            ),
            FunctionExample(
                sql=(
                    "SELECT * FROM cal.main.trading_sessions(DATE '2026-01-01', DATE '2026-01-31', exchange := 'XLON')"
                ),
...
class TradingScheduleFunction(TableFunctionGenerator[_TradingScheduleArgs]):
    ...
    class Meta:
        ...
        examples = [
            FunctionExample(
                sql="SELECT * FROM cal.main.trading_schedule(DATE '2026-11-25', DATE '2026-11-30')",
